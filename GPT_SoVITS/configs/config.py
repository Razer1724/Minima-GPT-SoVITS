...
name2sovits_path = {
    ("Use v2 base model directly without training!"): "GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth",
    ("Use v2Pro base model directly without training!"): "GPT_SoVITS/pretrained_models/v2Pro/s2Gv2Pro.pth",
    ("Use v2ProPlus base model directly without training!"): "GPT_SoVITS/pretrained_models/v2Pro/s2Gv2ProPlus.pth",
}
name2gpt_path = {
    (
        "Use v2 base model directly without training!"
    ): "GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt",
    ("Use v3 base model directly without training!"): "GPT_SoVITS/pretrained_models/s1v3.ckpt",
}
SoVITS_weight_root = [
    "SoVITS_Weights/SoVITS_weights_V1",
    "SoVITS_Weights/SoVITS_weights_v2",
    "SoVITS_Weights/SoVITS_weights_v3",
    "SoVITS_Weights/SoVITS_weights_v4",
    "SoVITS_Weights/SoVITS_weights_v2Pro",
    "SoVITS_Weights/SoVITS_weights_v2ProPlus",
]
GPT_weight_root = [
    "GPT_Weights/GPT_weights_V1",
    "GPT_Weights/GPT_weights_v2",
    "GPT_Weights/GPT_weights_v3",
    "GPT_Weights/GPT_weights_v4",
    "GPT_Weights/GPT_weights_v2Pro",
    "GPT_Weights/GPT_weights_v2ProPlus",
]
SoVITS_weight_version2root = {
    "v1": "SoVITS_Weights/SoVITS_weights_V1",
    "v2": "SoVITS_Weights/SoVITS_weights_v2",
    "v3": "SoVITS_Weights/SoVITS_weights_v3",
    "v4": "SoVITS_Weights/SoVITS_weights_v4",
    "v2Pro": "SoVITS_Weights/SoVITS_weights_v2Pro",
    "v2ProPlus": "SoVITS_Weights/SoVITS_weights_v2ProPlus",
}
GPT_weight_version2root = {
    "v1": "GPT_Weights/GPT_weights_V1",
    "v2": "GPT_Weights/GPT_weights_v2",
    "v3": "GPT_Weights/GPT_weights_v3",
    "v4": "GPT_Weights/GPT_weights_v4",
    "v2Pro": "GPT_Weights/GPT_weights_v2Pro",
    "v2ProPlus": "GPT_Weights/GPT_weights_v2ProPlus",
}
...
CPU_INFO: str = "0\tCPU " + ("Training on CPU (slower)")
